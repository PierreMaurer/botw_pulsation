...
export default function Navbar() {
  ...
  return (
    <nav className="absolute top-0 left-0 right-0 z-50">
      <div className="flex w-full max-w-[1440px] mx-auto h-[100px] px-[22px] md:px-[42px] justify-between items-center">
        {/* Logo */}
        <div className="flex h-[63px] justify-center items-center gap-2.5">
          <p className="text-white/80 text-center font-display text-[25.6px] font-normal tracking-[2.56px] uppercase">
            SYNC
          </p>
        </div>

        {/* Desktop Navigation */}
        <div className="hidden md:flex h-[63px] py-[10px] pr-[20px] pl-[1px] justify-center items-center gap-[90px]">
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden absolute top-[100px] left-0 right-0 bg-black/95 transition-all ${isOpen ? "opacity-100 visible" : "opacity-0 invisible"}`}>
